...
Tweet Académie est une application web de microblogging inspirée de Twitter. Elle permet aux utilisateurs de publier des messages courts, de suivre d'autres membres, de consulter un fil d'actualité, de répondre, de retweeter, et d'utiliser des hashtags. Le projet a été réalisé en équipe dans le cadre d'un apprentissage des bonnes pratiques de développement web, de la gestion de projet et du travail collaboratif.

#### Conception

Le projet a été conçu en suivant une architecture MVC (Model - View - Controller) pour séparer la logique métier, la présentation et la gestion des données. L'équipe a utilisé PHP pour le back-end, JavaScript pour les interactions dynamiques côté client, et TailwindCSS/Skeleton pour le design. La gestion de projet s'est appuyée sur GitHub Projects, avec une répartition claire des rôles (Tech Lead, Product Owner, etc.) et des revues de code systématiques pour garantir la qualité. Les choix techniques ont été guidés par la volonté de produire une application moderne, responsive et facilement maintenable.
